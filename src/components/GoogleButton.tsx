...
// Tombol Google bersama login & register. Tanpa kredensial OAuth (dev / belum
// diisi .env) tombol tampil disabled + tooltip — roadmap placeholder, sesuai
// keputusan desain user. Klik → alur redirect Google via next-auth client.
// User baru → ditangkap pages.newUser (step 2 wizard); user lama → landing.
