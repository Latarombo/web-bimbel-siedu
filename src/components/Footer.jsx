...
const Footer = () => {
  const programBelajar = [
    { name: 'TK', href: '/classes/tk' },
    { name: 'SD', href: '/classes/sd' },
    { name: 'SMP', href: '/classes/smp' },
    { name: 'SMA', href: '/classes/sma' },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-gray-600 text-base leading-relaxed mb-8 max-w-md">
              An integrated learning management platform for the future of your
              child&apos;s education.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-600">+62 811 2233 4455</span>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-600">halo@siedu.id</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-gray-600 text-sm">
              © 2026 Siedu. All rights reserved.
            </p>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-linear-to-tr from-yellow-400 via-red-500 to-purple-600 flex items-center justify-center hover:opacity-80 transition-opacity"
