    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <Card className="mt-4">
          <CardPad>
            <p className="text-sm text-amber-800">
              Bayar dalam 24 jam sejak pengajuan, kalau tidak pendaftaran batal otomatis dan kuota
              dilepas (BR#2).
            </p>
          </CardPad>
        </Card>
        ...
        <Card className="mt-4">
          <CardPad>
            <p className="text-sm text-red-700">
              Ada tunggakan — segera lunasi tagihan untuk menghindari pembatalan (BR#7).
            </p>
          </CardPad>
        </Card>
      ) : null}
      {status.startsWith("dibatalkan") ? (
        <Card className="mt-4">
          <CardPad>
            <p className="text-sm text-muted">
              Pendaftaran dibatalkan ({status.replaceAll("_", " ")}). Tanpa tombol aksi — sesuai
              kebijakan BR#19, DP hangus untuk pembatalan dari orang tua.
            </p>
          </CardPad>
        </Card>
      ) : null}
