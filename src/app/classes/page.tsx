export default function Page({ params }: { params?: Record<string,string> }) {
  return (
    <div style={{padding:24}}>
      <h1 style={{fontSize:24,fontWeight:700}}>Browse Classes — Katalog</h1>
      <p style={{color:'#666',marginTop:8}}>Route: <code>/classes</code></p>
      <p style={{marginTop:12}}>Daftar semua kelas. Reuse untuk Guest & Parent (C2).</p>
