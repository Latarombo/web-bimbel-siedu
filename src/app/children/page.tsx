export default function Page({ params }: { params?: Record<string,string> }) {
  return (
    <div style={{padding:24}}>
      <h1 style={{fontSize:24,fontWeight:700}}>Manage Children (list)</h1>
      <p style={{color:'#666',marginTop:8}}>Route: <code>/children</code></p>
      <p style={{marginTop:12}}>C8 — Di dropdown Parent</p>
