export default function Page({ params }: { params?: Record<string,string> }) {
  return (
    <div style={{padding:24}}>
      <h1 style={{fontSize:24,fontWeight:700}}>Admin — Subjects</h1>
      <p style={{color:'#666',marginTop:8}}>Route: <code>/admin/subjects</code></p>
      <p style={{marginTop:12}}>E2 — list+form</p>
