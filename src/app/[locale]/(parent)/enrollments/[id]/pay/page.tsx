            ...
            <CardPad>
              ...
              <ul className="mt-3 grid gap-1 text-sm">
                <li className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1 border-t border-slate-100 pt-2">
                  <span className="text-muted">{tr("text055")}</span>
                  <b>{SITE.nama}</b>
                </li>
                <li className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1 border-t border-slate-100 pt-2">
                  <span className="text-muted">{tr("text056")}</span>
                  <span>
                    {SITE.email} · {SITE.telepon}
                  </span>
                </li>
                <li className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1 border-t border-slate-100 pt-2">
                  <span className="text-muted">{tr("text057")}</span>
                  <span className="text-right font-medium">
                    {label} — {a[0].nama} (#{bill.id})
                  </span>
                </li>
                <li className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1 border-t border-slate-100 pt-2">
                  <span className="text-muted">{tr("text058")}</span>
