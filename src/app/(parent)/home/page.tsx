...
export default async function ParentHome() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      <header className="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            {jumlahAnak} anak terdaftar · {aktif.length} pendaftaran aktif.
          </p>
        </div>
      ...
      {/* Ringkasan — pola Dashboard Card DESIGN.md: top border 4px per kategori
          (biru akademik, emerald keuangan, amber jadwal). */}
                  ...
                  <Card>
                    <CardPad className="flex flex-wrap items-center justify-between gap-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        <ButtonLink href={`/enrollments/${p.id}`} variant="outline">
                          Detail
                        </ButtonLink>
                      </div>
                    </CardPad>
