export default function Page({ params }: { params?: Record<string,string> }) {
  return (
    <div style={{padding:24}}>
      <h1 style={{fontSize:24,fontWeight:700}}>Register — Step 3 (profil Anak)</h1>
      <p style={{color:'#666',marginTop:8}}>Route: <code>/register/child-info</code></p>
      <p style={{marginTop:12}}>B4</p>
