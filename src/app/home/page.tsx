export default function Page({ params }: { params?: Record<string,string> }) {
  return (
    <div style={{padding:24}}>
      <h1 style={{fontSize:24,fontWeight:700}}>Parent Home (Dashboard)</h1>
      <p style={{color:'#666',marginTop:8}}>Route: <code>/home</code></p>
      <p style={{marginTop:12}}>C1 — Sudah didesain lengkap, placeholder dulu.</p>
